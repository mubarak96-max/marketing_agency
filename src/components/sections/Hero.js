        ...
        <section className="relative min-h-screen flex items-center bg-section-dark">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
                <div className="text-center">
                    <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-text-on-dark mb-6">
                        Professional Website Design, Mobile App Development & Digital Marketing in Uganda
                    </h1>
                    <p className="text-xl md:text-2xl text-text-muted-dark mb-8">
                        We build websites, mobile apps, and paid growth systems for ambitious businesses in Kampala and across Uganda.
                    </p>
                    ...
                    <div className="mt-16 flex flex-col sm:flex-row justify-center items-center gap-8 text-text-on-dark">
                        <div className="text-center">
                            <span className="block text-3xl font-bold text-brand-accent">57+</span>
                            <span className="text-sm">Projects Completed</span>
                        </div>
                        <div className="hidden sm:block h-8 w-px bg-brand-accent" />
                        <div className="text-center">
                            <span className="block text-3xl font-bold text-brand-accent">UGX 1.5B+</span>
                            <span className="text-sm">Pipeline Influenced</span>
                        </div>
                        <div className="hidden sm:block h-8 w-px bg-brand-accent" />
                        <div className="text-center">
